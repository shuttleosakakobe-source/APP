...
GAS_WEBAPP_URL = "https://script.google.com/macros/s/AKfycbyHKwCg_FtaCPvPyQUxH6xAHCYdTzp35gH47sc9PeKSilIqubs2Y2-5ncxV8bDRJNCe/exec"
...
def render_daily_checklist():
    ...
    am_items = [
        ...
        "【**メンテ終了後**】 レンタルサービス準備 納品書 [300→331] (日付[前日発送分]→F1)",
